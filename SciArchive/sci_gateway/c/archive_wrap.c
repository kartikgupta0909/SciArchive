...
int _wrap_ArchiveList(SWIG_GatewayParameters) {
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  int alloc1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ArchiveList" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = (char *)(buf1);
  result = (char *)ArchiveList(arg1);
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SWIG_SciString_FromCharPtr(pvApiCtx, SWIG_Scilab_GetOutputPosition(), (const char *)result)))) return SWIG_ERROR;
...
int SWIG_CreateScilabVariables(void *_pvApiCtx) {  return SWIG_OK;
}
...
extern "C"
#endif
int archive_Init(SWIG_GatewayParameters) {
